...
import com.willianrosa.cursomc.domain.PagamentoComCartao;
...
import com.willianrosa.cursomc.domain.enums.Perfil;
...
import com.willianrosa.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instanceTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "williankeji05@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "willianjapa100@gmail.com", "11736667025", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("98463323","34748393"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "123", null, "Centro", "38777232", cli2, c2);
